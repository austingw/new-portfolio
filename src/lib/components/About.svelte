	...
	>
		...
		<div>
			<p class="pb-4">
				...
				passion for learning, DIY, and creative problem-solving. I love software development,
				because it allows me the opportunity to use those passions to make engaging, feature-rich
